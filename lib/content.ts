  ...
  panels: {
    intro: {
      ...
      /* the interiors the 3D flip gallery deals across this panel; its two
         arrangements refer to them by position in this list */
      photos: [
...
export const book = {
  ...
  background: "/images/book-room.webp",
  spreads: [
    {
...
export const projectFacts = {
  strap: "A place to live — to return\nyear after year",
  lead: "Four measures, held to from the first drawing through to the day the keys change hands.",
  ...
  items: [
    ...
    },
    {
      ...
      label: "Time",
      value:
        "A place is finished when it stops asking for attention. These interiors are composed for the hours you actually keep in them — the ordinary weekday as much as the long evening.",
    },
  ],
};
