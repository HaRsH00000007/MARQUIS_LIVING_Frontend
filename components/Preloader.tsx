...
/**
 * ERA Residence Opening Animation & Preloader.
 * Replicates the authentic intro splash sequence from era-residence.com:
 *  - 1st visit: 4s full intro splash with ERA mark, Costa del Sol / Era Residence / Estepona typography,
 *    animated progress fill track, architectural decor frame lines, watermark background,
            ...
            <div className="grid">
              <div className={styles.sTitle}>
                ...
                <p data-part="p" className={`l1 a-center ${styles.partInitial}`}>
                  Era Residence<br />A place to return to.
                </p>
              </div>
            </div>
          </div>
